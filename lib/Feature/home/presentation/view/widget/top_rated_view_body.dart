...
class _TopRatedViewBodyState extends State<TopRatedViewBody> {
 late ScrollController _scrollController;
  ...
  Widget build(BuildContext context) {
      ...
      if (state is TopRatedMoviesSuccess || state is TopRatedMoviesFailure || state is TopRatedMoviesPaginationLoading) {
        return ListView.builder(
          controller: _scrollController,
            itemBuilder: (context, index) {
              return  PopularAndTopRatedCardMovie(movie:moviesList[index],);
            },
